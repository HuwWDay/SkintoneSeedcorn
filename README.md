This folder contains all the code Huw Day wrote for the Seedcorn project led by James Pope on Working towards more universal skin cancer identification with AI (April 2024 - June 2024).
